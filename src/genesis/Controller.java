...
public class Controller {
  ...
  public void setControllerFieldsForeign(
    ControllerField controllerFieldsForeign
  ) {
  ...
  public void setControllerChangeInstanciation(
    HashMap<String, String> controllerChangeInstanciation
  ) {
  ...
  public void setControllerWhereInstanciation(
    HashMap<String, String> controllerWhereInstanciation
  ) {
  ...
  public void setControllerForeignInstanciation(
    HashMap<String, String> controllerForeignInstanciation
  ) {
  ...
  public void setControllerForeignContextParam(
    String controllerForeignContextParam
  ) {
  ...
  public void setControllerForeignContextInstanciation(
    String controllerForeignContextInstanciation
  ) {
    this.controllerForeignContextInstanciation =
